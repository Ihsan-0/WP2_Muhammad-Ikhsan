...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <?php }?>
            <?= $this->session->flashdata('pesan') ?>
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#kategoriBaruModal"><i class="fas fa-file-alt"> Tambah Kategori </i></a>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $k['kategori']; ?></td>
                        <td>
                            <a href="<?= base_url('buku/ubahBuku/').$k['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.''.$k['kategori'];?>');" class="badge badge-danger"><i class="fas fa-trash"></i>Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <select name="kategori" class="form-control">
                            <option value="">Piih Katgori</option>
                            <?php
