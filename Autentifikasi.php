...
class Autentifikasi extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('pesan', '<div
                    class="alert alert-danger alert-message" role="alert">User
                    belum diaktifikasi!!</div>');
                        redirect('autentifikasi');
            }
        } else {
            $this->session->set_flashdata('pesan', '<div
                    class="alert alert-danger alert-message" role="alert">Email
                    tidak terdaftar!!</div>');
                        redirect('autentifikasi');
        }
    }
    ...
    public function registrasi()
    {
        ...
        dan password harus sama dengan repeat password dengan membuat pesan error dengan bahasa sendiri
        yaitu jika password dan repeat password tidak diinput sama, maka pesannya 'Password Tidak Sama'.
        ...
        /*jika tidak disubmit kemudian validasi form diatas tidak berjalan, maka akan tetap berada di tampilan registrasi.
        ...
        if ($this->form_validation->run() == false) {
            ...
            role="alert">Selamat!! akin member anda sudah dibuat. Silahkan Aktivasi Akun anda</div>');
            redirect('autentifikasi');
        }
    }
}