...
<div class="container-fluid">
            ...
            <div class="card border-left-danger shadow h-100 py-2 bg-primary">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('user/anggote'); ?>"><i class="fas
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-10 py-2 bg-warning">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-md font-weight-bold text-white text-
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('buku'); ?>"><i class="fas fa-book
                        fa-3x text-primary"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-left-success shadow h-100 py-2 bg-danger">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('user'); ?>"><i class="fas fa-user-tag
                        fa-3x text-success"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h1 mb-0 font-weight-bold text-white">
                            <?php
                            $where = ['dibooking != 0'];
                            $totalbooking = $this->ModelBuku->total
                            ('dibooking', $where);
                            echo $totalbooking;
                            ?>
                        </div>
